...
import { DeathAnniversary } from '../../interfaces/death-anniversary.interface';
import Swal from 'sweetalert2';
import * as moment from 'moment';

@Component({
  selector: 'app-death-anniversary',
  templateUrl: './death-anniversary.component.html',
  styleUrls: ['./death-anniversary.component.css']
})
export class DeathAnniversaryComponent implements OnInit {
  ...
  campaigns : Campaigns = { // este arreglo es para realiza el registro de campañas
    ...
    name_campaigns: 'Campaña aniversario de fallecidos', 
    id_plantilla: 0,
    business: '',
 ...
 getDataCliente() {
  ...
  if(this.empresass[0] === this.selectedEmpresas[0]) {
   ...
   this.service.getDataClienteFunerariaFallecidos()
    .subscribe(
      resp => {
    ...
    this.service.getDataClienteFallecidos()
    .subscribe(
      resp => {
        this.datosClientes = resp;
        //console.log(this.datosCliente)
   ...
   // alert("eligio Cementerio")
    ...
    this.service.getDataClienteAltamiraFallecidos()
    ...
    this.service.getDataClienteIndelpaFallecidos()
    .subscribe(
      resp => {
        this.datosClientes = resp;
        //console.log(this.datosCliente)
